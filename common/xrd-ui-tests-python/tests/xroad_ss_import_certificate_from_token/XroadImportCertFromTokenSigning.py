...
class XroadImportCertFromTokenSigning(unittest.TestCase):
    ...
    def test_aimport_cert_from_token(self):
        ...
        try:
            ...
            main.log('working_cert_id={0},auth_cert_id={1}, expired_cert_id={2}, existing_cert_id={3}'.format(working_cert_id,auth_cert_id, expired_cert_id, existing_cert_id))
    ...
    def test_bimport_cert_from_token_no_ca(self):
        main = MainController(self)
        # Set test name and number
        ...
        main.log('ocsp_url {0}, ocsp_cert_filename {1}'.format(ocsp_url, ocsp_cert_filename))
    ...
    def test_cimport_cert_from_token_global_conf_error(self):
        main = MainController(self)
        # Set test name and number
    ...
    def test_dimport_cert_from_token_no_client(self):
        ...
        test_client_id = main.config.get('hwtoken.test_client_id')
